...
<table>
  ...
  <tr>
    <td><a href="/confirm/{{context.voucher}}/{{ context.data.0.id }}"><button>select</button></a></td>
    <td><a href="/confirm/{{context.voucher}}/{{ context.data.1.id }}"><button>select</button></a></td>
  </tr>
</table>
